...
if __name__ == "__main__":
    ...
    while True:
        res = input("Você quer encerrar o programa? [S/N] ").strip().upper()[0]
        ...
        while True:
            ...
            match res:
                ...
                case "E":
                    ...
                    individuo.verificar_morte()
                case "S":
                    print(f"{individuo.nome} foi uma grande pessoa... Era tão incrível, que pensou que o mundo não suportaria tamanha pessoa e encerrou sua história.")
                    break
